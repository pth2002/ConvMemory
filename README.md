...
### Chinese ConvMemory: OPC Student BGE
...
reports R@10 0.9913, Hit@1 0.7442, and MRR 0.8484. In warm-memory pool scans,
the student is much faster than the online teacher for large candidate pools;
